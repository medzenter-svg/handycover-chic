    ...
    <section className="mx-auto max-w-[1400px] px-6 pt-8">
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 md:grid-cols-5 xl:grid-cols-10">
        {categories.map((c) => (
          ...
          >
            <div
              className={`grid h-12 w-12 shrink-0 place-items-center overflow-hidden rounded-xl bg-gradient-to-br ${c.gradient} p-0.5`}
            >
              <img src={c.image} alt="" width={120} height={120} className="h-full w-full object-cover object-center" loading="lazy" />
            </div>
