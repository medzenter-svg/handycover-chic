    ...
    <section className="mx-auto max-w-[1400px] px-6 pt-10">
      ...
      <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {guides.map((g) => (
          ...
          >
            <div className="grid h-[74px] w-[74px] shrink-0 place-items-center overflow-hidden rounded-xl bg-card/80 p-0.5 shadow-soft backdrop-blur">
              <img src={g.image} alt="" width={148} height={148} className="h-full w-full object-cover object-center" loading="lazy" />
            </div>
