...
export const products: Product[] = [
  ...
  { id: "iphone-clear-case", title: "Transparente Hülle iPhone 14", benefit: "Vergilbungsfrei, ultra dünn.", image: pCase, badge: "Transparent", badgeGradient: "from-sky-400 to-cyan-500", rating: 4.5, reviews: "2.870", price: "9,99 €", features: ["Transparent", "Ultradünn"], amazonUrl: "#", category: "iphone" },
  { id: "iphone-bumper", title: "Bumper Schutzrahmen iPhone 16", benefit: "Maximaler Kantenschutz, minimalistisch.", image: pCase, badge: "Bumper-Rahmen", badgeGradient: "from-zinc-500 to-slate-600", rating: 4.4, reviews: "612", price: "13,99 €", features: ["Kantenschutz"], amazonUrl: "#", category: "iphone" },
  { id: "iphone-wallet", title: "Wallet Case iPhone 15", benefit: "Mit Kartenfach, magnetisch.", image: pWallet, badge: "Wallet-Hülle", badgeGradient: "from-emerald-400 to-teal-500", rating: 4.6, reviews: "1.984", price: "22,99 €", features: ["Kartenfach", "MagSafe"], amazonUrl: "#", category: "iphone" },
  { id: "iphone-rugged", title: "Outdoor Rugged Case iPhone 16", benefit: "Sturzfest nach Militärstandard.", image: pCase, badge: "Outdoor", badgeGradient: "from-stone-500 to-zinc-700", rating: 4.7, reviews: "2.117", price: "24,99 €", oldPrice: "34,99 €", features: ["Sturzfest", "Kratzschutz"], amazonUrl: "#", category: "iphone" },

  // Samsung
  { id: "samsung-clear-case", title: "Klare Hülle Samsung S24 Ultra", benefit: "Kristallklar, MagSafe-kompatibel.", image: pSamsung, badge: "Transparent", badgeGradient: "from-sky-400 to-blue-500", rating: 4.6, reviews: "1.512", price: "13,99 €", features: ["Transparent", "Ultradünn"], amazonUrl: "#", category: "samsung" },
  { id: "samsung-wallet", title: "Wallet Case Samsung S24", benefit: "Mit Standfunktion und Kartenfach.", image: pWallet, badge: "Wallet-Hülle", badgeGradient: "from-violet-400 to-indigo-500", rating: 4.5, reviews: "987", price: "19,99 €", features: ["Kartenfach", "Standfunktion"], amazonUrl: "#", category: "samsung" },
  { id: "samsung-rugged", title: "Outdoor Case Samsung S24 Ultra", benefit: "Robuster Schutz für unterwegs.", image: pSamsung, badge: "Outdoor", badgeGradient: "from-stone-500 to-zinc-700", rating: 4.7, reviews: "1.342", price: "22,99 €", oldPrice: "29,99 €", features: ["Sturzfest"], amazonUrl: "#", category: "samsung" },
  { id: "samsung-glas", title: "Displayschutzglas für Samsung Galaxy S24 Ultra", benefit: "9H Härte, mit Schablone.", image: pScreen, badge: "Schutzglas", badgeGradient: "from-cyan-400 to-sky-500", rating: 4.7, reviews: "5.612", price: "12,99 €", features: ["9H Härte"], amazonUrl: "#", category: "samsung" },
  { id: "samsung-charger", title: "Samsung 25 W Super Fast Charger", benefit: "Original Schnellladegerät USB-C.", image: pCharger, badge: "Original", badgeGradient: "from-indigo-500 to-blue-600", rating: 4.8, reviews: "8.220", price: "19,99 €", features: ["Schnellladen"], amazonUrl: "#", category: "samsung" },
  ...
  { id: "magsafe-grip", title: "MagSafe Griff & Ständer", benefit: "Besserer Halt, klappbarer Stand.", image: pWallet, badge: "Griff", badgeGradient: "from-rose-400 to-pink-500", rating: 4.5, reviews: "920", price: "14,99 €", features: ["MagSafe", "Standfunktion"], amazonUrl: "#", category: "magsafe" },
  { id: "magsafe-puck", title: "MagSafe Wireless Charger Puck", benefit: "Klein, magnetisch, 15W Power.", image: pCharger, badge: "15 W", badgeGradient: "from-purple-500 to-pink-500", rating: 4.6, reviews: "1.760", price: "21,99 €", features: ["MagSafe", "15 W"], amazonUrl: "#", category: "magsafe" },
  ...
  { id: "display-privacy", title: "Blickschutz-Schutzglas für iPhone 16 Pro", benefit: "Blickschutz – nur du siehst dein Display.", image: pScreen, badge: "Blickschutz", badgeGradient: "from-slate-500 to-zinc-700", rating: 4.5, reviews: "1.420", price: "14,99 €", features: ["Blickschutz"], amazonUrl: "#", category: "display" },
  { id: "display-matt", title: "Mattes Schutzglas für iPhone 15 Pro", benefit: "Reflexionsfrei, fingerabdruckfrei.", image: pScreen, badge: "Mattes Glas", badgeGradient: "from-zinc-400 to-slate-500", rating: 4.6, reviews: "2.018", price: "12,99 €", features: ["Mattes Glas", "Entspiegelt"], amazonUrl: "#", category: "display" },
  { id: "display-folie", title: "Hydrogel-Schutzfolie für Samsung Galaxy S24", benefit: "Selbstheilend, dünn, fullscreen.", image: pScreen, badge: "Schutzfolie", badgeGradient: "from-emerald-400 to-teal-500", rating: 4.3, reviews: "812", price: "7,99 €", features: ["Selbstheilend"], amazonUrl: "#", category: "display" },
  { id: "display-watch", title: "Schutzglas für Apple Watch, 3er-Pack", benefit: "Schutz für das Watch-Display.", image: pScreen, badge: "Apple Watch", badgeGradient: "from-violet-400 to-purple-500", rating: 4.6, reviews: "1.215", price: "8,99 €", features: ["3er-Pack"], amazonUrl: "#", category: "display" },
  { id: "display-camera", title: "Kameraschutzglas für iPhone 16 Pro", benefit: "Schützt die Kamera vor Kratzern.", image: pScreen, badge: "Kameraschutz", badgeGradient: "from-indigo-400 to-blue-500", rating: 4.5, reviews: "980", price: "9,99 €", features: ["Kameraschutz"], amazonUrl: "#", category: "display" },

  // Charging
  { id: "anker-65w", title: "USB-C GaN-Ladegerät 65 W", benefit: "Lädt Phone, Tablet & Laptop.", image: pCharger, badge: "GaN", badgeGradient: "from-emerald-500 to-teal-600", rating: 4.8, reviews: "12.420", price: "34,99 €", oldPrice: "49,99 €", features: ["GaN", "65 W"], amazonUrl: "#", category: "charging" },
  ...
  { id: "ugreen-c-c", title: "USB-C auf USB-C Kabel, 2 m (100 W)", benefit: "100W Power Delivery, robust.", image: pCable, badge: "100 W", badgeGradient: "from-blue-400 to-indigo-500", rating: 4.7, reviews: "8.412", price: "12,99 €", features: ["100 W", "2 m"], amazonUrl: "#", category: "charging" },
  ...
  { id: "wireless-pad", title: "Kabelloses Ladepad 15W", benefit: "Schick, schnell, universell.", image: pCharger, badge: "Kabellos", badgeGradient: "from-purple-400 to-pink-500", rating: 4.5, reviews: "1.882", price: "19,99 €", features: ["Kabellos", "15 W"], amazonUrl: "#", category: "charging" },
  { id: "anker-100w", title: "Reiseladegerät 100 W mit Wechseladaptern", benefit: "Reise-Ladegerät mit Wechseladaptern.", image: pCharger, badge: "Reise-Set", badgeGradient: "from-amber-400 to-orange-500", rating: 4.7, reviews: "1.420", price: "59,99 €", oldPrice: "79,99 €", features: ["100 W", "Reise-Set"], amazonUrl: "#", category: "charging" },

  // Powerbanks
  { id: "anker-pb-20k", title: "Powerbank 20.000 mAh mit Schnellladen", benefit: "Riesige Kapazität für mehrere Tage.", image: pPb1, badge: "20.000 mAh", badgeGradient: "from-emerald-500 to-teal-600", rating: 4.8, reviews: "9.221", price: "39,99 €", oldPrice: "59,99 €", features: ["20.000 mAh", "USB-C PD"], amazonUrl: "#", category: "powerbanks" },
  ...
  { id: "wireless-pb", title: "Wireless Powerbank 10.000 mAh", benefit: "Kabellos und per USB-C laden.", image: pPb2, badge: "Kabellos", badgeGradient: "from-purple-500 to-pink-500", rating: 4.5, reviews: "1.110", price: "24,99 €", features: ["Kabellos", "10.000 mAh"], amazonUrl: "#", category: "powerbanks" },

  // Car
  { id: "car-cd-mount", title: "CD-Schacht Handyhalterung", benefit: "Verschwindet im CD-Schacht – elegant.", image: pMount, badge: "CD-Schacht", badgeGradient: "from-slate-500 to-zinc-700", rating: 4.5, reviews: "1.120", price: "14,99 €", features: ["CD-Schacht"], amazonUrl: "#", category: "car" },
  ...
  { id: "car-charger-fast", title: "USB-C Autoladegerät 45 W PD", benefit: "Schnellladen auch im Auto.", image: pCar, badge: "45 W", badgeGradient: "from-orange-400 to-red-500", rating: 4.7, reviews: "3.410", price: "14,99 €", features: ["45 W", "USB-C PD"], amazonUrl: "#", category: "car" },
  { id: "car-magsafe", title: "MagSafe Halterung mit Wireless Charging", benefit: "Magnetisch andocken und laden.", image: pMount, badge: "MagSafe", badgeGradient: "from-purple-500 to-pink-500", rating: 4.6, reviews: "1.812", price: "29,99 €", oldPrice: "39,99 €", features: ["MagSafe", "Kabellos"], amazonUrl: "#", category: "car" },
